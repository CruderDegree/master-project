...
\date{October 14\textsuperscript{th}, 2020}
...
\end{enumerate}
The \proc{Up-to-down} procedure was my mainly used method for estimating the QSL of the system shown on figure \ref{fig:QSL}.\\
