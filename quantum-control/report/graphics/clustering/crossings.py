"""
We define in this script a shake to be a zero-crossing (a "crossing")
"""
...
def main():
    ...
    fig.colorbar(im)
    ax.plot(Ts[-1],infs[-1],'xr',alpha=0.8, fillstyle='none',
            label='Not included', markersize=5)
    
    # Edit fig
    ax.set(xlabel="T [ms]", 
           yscale="log", 
           ylabel="1 - F",
           title="Control performance colored by 0-crossings")
    
    ax.legend(loc="best")
    # Save fig
    fig.savefig("crossings.pdf")
    fig.savefig("crossings.png")
