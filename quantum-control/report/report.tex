...
%TODO How Composer was used in this challenge
...
%TODO Forklarende tekst på billede
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{graphics/composerScreens/grape_highlight.png}
	\caption{Screenshot from Quantum Composer showing how a quantum control problem can be optimized using \proc{Grape}.}
	%TODO Kommenter på forskellige grafer og hvad de viser
...
%TODO Write about how data is presented (matplotlib in Python)
...
%TODO More ticks on y-axis, one point is not enough
\begin{figure}
