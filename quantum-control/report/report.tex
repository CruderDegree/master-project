...
%TODO Remember that the uncertainty of energies is due to the way the spectrum is calculated, and so it should technecally be recalculated each time the beta value is updated to minimize variance.

%TODO Mention how this is a QSL estimate and that it was only optimized for 100 iterations of Grape due to the way sampling data in Composer Works, therefore, it would be a matter of trying more seeds and optimizing for longer to find a presumably even lower estimate
